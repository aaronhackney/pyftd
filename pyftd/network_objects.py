...
class FTDNetworkObjects:
    ...
    @FTDAPIWrapper()
    def get_external_ca_certificate_list(self, limit=9999, offset=0, filter=""):
        """
        Get a list of External CA certificates (External = AnyConnect Certificate)
        :param limit: limit the number of records returned
        :param offset: starting index of records to return (for paging)
        :param search: limit returned results based on filters like "name:foo" or "fts~bar"
        ...
        :return: list of ExternalCACertificates
        """
        return (
    ...
    @FTDAPIWrapper()
    def get_external_ca_certificate(self, obj_id):
        """
    ...
    @FTDAPIWrapper()
    def create_external_ca_certificate(self, certificate_obj):
        """
    ...
    @FTDAPIWrapper()
    def edit_external_ca_certificate(self, certificate_obj):
        """
    ...
    @FTDAPIWrapper()
    def delete_external_ca_certificate(self, obj_id):
        """
